...
| Guided Data Lab                      | Owner-approved profiling, cleaning, descriptive trends, charts and prediction evaluation | Temporary Sandbox with Pandas, openpyxl and scikit-learn           | No third-party SaaS account; Workers Paid runtime required |
...
| Data analysis and visualization | NumPy/Pandas analysis plus Matplotlib and browser-native charts                                        | Guided CSV/TSV/JSON/XLSX profiling, cleaning, descriptive trends, in-chat charts and artifacts ready           |
