...
header{max-width:620px;margin:0 auto;padding:22px 20px 8px!important;display:flex!important;align-items:center!important;gap:12px!important}header:before{content:"U1";display:flex;align-items:center;justify-content:center;width:42px;height:42px;flex:0 0 42px;border-radius:13px;background:linear-gradient(145deg,#22c8ff 0%,#1688ff 50%,#0e48b8 100%);color:#fff;font-size:16px;font-weight:850;letter-spacing:-1px;box-shadow:0 0 0 1px rgba(116,205,255,.38),0 12px 30px rgba(0,126,255,.25),inset 0 1px rgba(255,255,255,.35)}header:after{display:none!important}h1{font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;font-size:22px!important;font-weight:800!important;letter-spacing:-.6px!important;margin:0!important;color:#fff!important}p.sub{display:none!important}
...
(function(){
  function boot(){
    ...
    settings.innerHTML='<div class="section-title">Settings</div><div class="section-sub">API ključevi i podešavanja UNIT aplikacije.</div>';
    ...
    general.innerHTML='<div class="settings-heading">Opšte</div><div class="setting-row"><span>Integracije</span><span>›</span></div><div class="setting-row"><span>Notifikacije</span><span>›</span></div><div class="setting-row"><span>Tema</span><span>Tamna</span></div><div class="setting-row"><span>Jezik</span><span>Srpski</span></div><div class="setting-row"><span>O aplikaciji</span><span>UNIT</span></div>';
