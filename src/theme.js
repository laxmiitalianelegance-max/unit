...
header{max-width:620px;margin:0 auto;padding:22px 20px 8px!important;display:flex!important;align-items:center!important;gap:18px!important}header:before{content:"";display:block;width:88px;height:88px;flex:0 0 88px;border-radius:20px;background:url('https://cdn.shopify.com/s/files/1/1026/5047/8921/files/unit369-exact-logo.jpg?v=1787373410') center/cover no-repeat!important;box-shadow:0 10px 32px rgba(0,126,255,.26)}header:after{display:none!important}header .eyebrow{display:none!important}h1{font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important;font-size:24px!important;font-weight:800!important;letter-spacing:-.6px!important;margin:0!important;color:#fff!important}p.sub{display:none!important}
  ...
  async fetch(request, env, ctx) {
    ...
    if (request.method === "GET" && url.pathname === "/") {
      ...
      if (type.includes("text/html")) {
        ...
        const themed = html
          .replace(/<p\b[^>]*class=["'][^"']*\beyebrow\b[^"']*["'][^>]*>[\s\S]*?<\/p>/i,"")
