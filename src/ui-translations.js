...
export const UI_BASE = Object.freeze({
  ...
  dataTrend: "Trend analysis",
  dataTrendDate: "Time column",
  dataTrendMetric: "Metric",
  dataTrendDirection: "Direction",
  dataTrendPeriods: "Periods",
  dataTrendStart: "Start",
  dataTrendEnd: "End",
  dataTrendChange: "Change",
  dataTrendStrength: "Strength",
  dataTrendIncreasing: "Increasing",
  dataTrendDecreasing: "Decreasing",
  dataTrendStable: "Stable",
  dataTrendExploratoryNote:
    "A descriptive trend does not establish causation or guarantee future movement.",
  ...
  dataOperationTrend: "Find trends",
...
const UI_SR = Object.freeze({
  ...
  dataTrend: "Analiza trendova",
  dataTrendDate: "Vremenska kolona",
  dataTrendMetric: "Metrika",
  dataTrendDirection: "Smer",
  dataTrendPeriods: "Periodi",
  dataTrendStart: "Početak",
  dataTrendEnd: "Kraj",
  dataTrendChange: "Promena",
  dataTrendStrength: "Jačina trenda",
  dataTrendIncreasing: "Rastući",
  dataTrendDecreasing: "Opadajući",
  dataTrendStable: "Stabilan",
  dataTrendExploratoryNote:
    "Opisni trend ne dokazuje uzrok i ne garantuje buduće kretanje.",
  ...
  dataOperationTrend: "Pronalaženje trendova",
